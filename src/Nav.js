...
export default class Nav extends React.Component {
  render() {
    return (
      <div className={this.props.active ? "pages-nav pages-nav--open" : "pages-nav"}>

        <div className="pages-nav__item">
          <Link to="/" className="link link--page">Home</Link>
        </div>
        <div className="pages-nav__item">
          <Link to="/subpage" className="link link--page">Subpage</Link>
        </div>
        <div className="pages-nav__item">
          <Link to="/page3" className="link link--page">Page 3</Link>
        </div>
        <div className="pages-nav__item">
          <Link to="/" className="link link--page">Home</Link>
        </div>
        ...
        <div className="pages-nav__item pages-nav__item--small">
          <Link to="/" className="link link--page link--faded">Home</Link>
        </div>
        <div className="pages-nav__item pages-nav__item--small">
          <Link to="/subpage" className="link link--page link--faded">Subpage</Link>
        </div>
        <div className="pages-nav__item pages-nav__item--small">
          <Link to="/page3" className="link link--page link--faded">Page 3</Link>
        </div>
        ...
        <div className="pages-nav__item pages-nav__item--social">
          ...
          <a className="link link--social link--faded" href="#"><i className="fa fa-medium"></i><span className="text-hidden">Medium</span></a>
        </div>
